  ...
  const [ user, setUser ] = userState
    ...
    const submitForm = async (e) => {
        try {
          ...
          const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/users`, { name:name, email:email, password:password })
    ...
    return (
      ...
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Box component="form" onSubmit={submitForm} noValidate sx={{ mt: 3 }} to="/">
